...
public:
  JoyToFloat32MultiArrayNode() : Node("joy_to_float32_array") {
    publisher_ = this->create_publisher<std_msgs::msg::Float32MultiArray>("controller_one", 10);
    subscription_ = this->create_subscription<sensor_msgs::msg::Joy>(
      "joy_one", 10, std::bind(&JoyToFloat32MultiArrayNode::joy_callback, this, std::placeholders::_1));
  }

private:
  void joy_callback(const sensor_msgs::msg::Joy::SharedPtr msg) {
    RCLCPP_INFO(this->get_logger(), "Robot 1 Sending data... ");
